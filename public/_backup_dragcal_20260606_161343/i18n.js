...
const LANGS = {
    no: {
        ...
        hab_last_90:      'Siste 90 dager',
        hab_total_completions: 'Totalt fullført',
        hab_streak_current: 'rad nå',
        hab_week_streak:  'uker på mål',
        hab_best_week_streak: 'Beste ukerekke',
        hab_day_initials: 'M,T,O,T,F,L,S',
        hab_week_this:    'Denne uka',
        hab_week_ago:     '{n} uker siden',
        ...
        ai_free_limit_reached: 'Du har brukt opp de 10 gratis AI-genereringene denne måneden. Oppgrader for ubegrenset.',
        ...
        // Paywall
        paywall_eyebrow:        'Oppgrader',
        paywall_title:          'Få <em>ubegrenset</em> AI.',
        paywall_sub:            'Du kan bruke MyBoard gratis så lenge du vil — med 10 AI-genereringer per måned. Oppgrader for ubegrenset AI, uten avbrudd.',
        paywall_first30:        'de første 30 dagene',
        paywall_then:           'deretter',
        paywall_per_month:      '/ måned',
        paywall_per_month_label:'/ måned',
        paywall_no_trial_note:  'Du har allerede brukt prøveperioden — fortsetter med vanlig pris.',
        paywall_cancel:         'Si opp når som helst — ingen binding.',
        paywall_btn:            'Start prøveperioden',
        paywall_btn_no_trial:   'Oppgrader nå',
        paywall_switch_currency:'Bytt til {cur}',
        paywall_quote:          '"Tavlen din, for prisen av en kaffe."',
        paywall_manage:         'Administrer abonnement',
        paywall_back_to_board:  'Tilbake til tavlen',
        paywall_free_note:      'Du bruker gratisplanen · {used}/{limit} AI-genereringer brukt i denne måneden.',
        // Account menu
        ...
        account_status_none:     'Gratisplan',
        account_status_free:     'Gratisplan',
        account_free_usage:      '{used} / {limit} AI-genereringer brukt',
        account_upgrade:         'Oppgrader · ubegrenset AI',
    ...
    en: {
        ...
        hab_last_90:      'Last 90 days',
        hab_total_completions: 'Total completions',
        hab_streak_current: 'current streak',
        hab_week_streak:  'weeks on target',
        hab_best_week_streak: 'Best week run',
        hab_day_initials: 'M,T,W,T,F,S,S',
        hab_week_this:    'This week',
        hab_week_ago:     '{n} weeks ago',
        ...
        ai_free_limit_reached: 'You used all 10 free AI generations this month. Upgrade for unlimited.',
        ...
        // Paywall
        paywall_eyebrow:        'Upgrade',
        paywall_title:          'Get <em>unlimited</em> AI.',
        paywall_sub:            "You can use MyBoard free forever — with 10 AI generations a month. Upgrade for unlimited AI, no interruptions.",
        paywall_first30:        'for the first 30 days',
        paywall_then:           'then',
        paywall_per_month:      '/ month',
        paywall_per_month_label:'/ month',
        paywall_no_trial_note:  'You already used the intro trial — continuing at the regular price.',
        paywall_cancel:         'Cancel any time — no commitment.',
        paywall_btn:            'Start trial',
        paywall_btn_no_trial:   'Upgrade now',
        ...
        paywall_back_to_board:  'Back to board',
        paywall_free_note:      "You're on the free plan · {used}/{limit} AI generations used this month.",
        // Account menu
        ...
        account_status_none:     'Free plan',
        account_status_free:     'Free plan',
        account_free_usage:      '{used} / {limit} AI generations used',
        account_upgrade:         'Upgrade · unlimited AI',
